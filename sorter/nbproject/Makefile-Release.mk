...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sorter

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sorter: ${OBJECTFILES}
...
${OBJECTDIR}/drawing/visualizer.o: drawing/visualizer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/drawing/visualizer.o drawing/visualizer.cpp
...
${OBJECTDIR}/sorting_algorithms/general_sorter.o: sorting_algorithms/general_sorter.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sorting_algorithms/general_sorter.o sorting_algorithms/general_sorter.cpp
